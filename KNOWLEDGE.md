...
| `shorts.js` | 쇼츠 대본 생성(OpenAI gpt-5.4-mini) → 프로젝트/쇼츠대본 저장. 300~330자·18~22문장·치타아빠 해석(표현 방식 무작위)·투자지시 금지 규칙, 위반 시 최대 2회 재작성(checkScript). 숫자 장면·제목 3안·설명란(해시태그 3개)·태그 5~8개·고정 댓글. 채널 소개 줄은 CHANNEL_INTRO | generateShorts, shortsExists |
